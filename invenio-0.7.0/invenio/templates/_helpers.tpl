...
{{- define "invenio.opensearch.port" -}}
  {{- required "Missing .Values.opensearchExternal.port" .Values.opensearchExternal.port  -}}
{{- end -}}
{{- define "invenio.opensearch.http_auth.user" -}}
  {{- required "Missing .Values.opensearchExternal.http_auth.user" .Values.opensearchExternal.http_auth.user  -}}
{{- end -}}
{{- define "invenio.opensearch.http_auth.password" -}}
  {{- required "Missing .Values.opensearchExternal.http_auth.password" .Values.opensearchExternal.http_auth.password  -}}
{{- end -}}
...
INVENIO_APP_ALLOWED_HOSTS: '[".elb.amazonaws.com"]'
...
INVENIO_SEARCH_HN: '{{ include "invenio.opensearch.hostname" . }}'
INVENIO_SEARCH_AUTH: '{{ include "invenio.opensearch.http_auth.user" . }}'
INVENIO_SEARCH_HOSTS: "[{\"host\": \"{{ include "invenio.opensearch.hostname" $ }}\", \"port\": 443, \"scheme\": \"https\", \"http_auth\":[\"{{ include "invenio.opensearch.http_auth.user" . }}\",\"{{ include "invenio.opensearch.http_auth.password" . }}\"], \"timeout\":60, \"use_ssl\":True}]"
...
#INVENIO_REST_ENABLE_CORS: "TRUE"
#INVENIO_CORS_RESOURCES: '{r"/*": {"origins": "*"}}'
{{- end -}}
